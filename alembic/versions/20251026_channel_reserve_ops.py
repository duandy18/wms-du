...
def upgrade():
    op.create_table(
        ...
        sa.UniqueConstraint("store_id", "ext_order_id", "ext_sku_id", "op", name="uq_reserve_idem_key"),
    )
    op.create_index("ix_reserve_ops_store_order", "channel_reserve_ops", ["store_id", "ext_order_id"], unique=False)
