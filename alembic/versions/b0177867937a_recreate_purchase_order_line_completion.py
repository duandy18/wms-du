"""recreate purchase_order_line_completion

Revision ID: b0177867937a
Revises: 9beb31ce43a3
Create Date: 2026-04-14 14:53:22.351073
...
revision: str = "b0177867937a"
down_revision: Union[str, Sequence[str], None] = "9beb31ce43a3"
...
def upgrade() -> None:
    ...
    # 吸收本地脏状态：若表被手工/失败迁移提前建出，先删再重建
    op.execute("DROP TABLE IF EXISTS purchase_order_line_completion CASCADE")
