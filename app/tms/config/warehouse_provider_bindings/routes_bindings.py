# app/tms/config/warehouse_provider_bindings/routes_bindings.py
# 分拆说明：
# - 本文件承载 TransportConfig / warehouse_provider_bindings 子域的绑定关系写接口；
# - URL 继续保留 /warehouses/... 口径，但物理归属已收口到 TMS / config；
# - 权限校验统一改为消费 app.tms.config.permissions。
