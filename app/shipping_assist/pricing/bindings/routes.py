# app/shipping_assist/pricing/bindings/routes.py
#
# 分拆说明：
...
from app.shipping_assist.pricing.bindings.read_routes import router as bindings_read_router
from app.shipping_assist.pricing.bindings.runtime_routes import router as bindings_runtime_router
from app.shipping_assist.pricing.bindings.summary_routes import router as bindings_summary_router
from app.shipping_assist.pricing.bindings.write_routes import router as bindings_write_router
