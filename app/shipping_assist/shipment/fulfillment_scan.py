# app/shipping_assist/shipment/fulfillment_scan.py
# 分拆说明：
# - 本文件从 app/services/outbound_ship_fulfillment_scan.py 迁入 app/shipping_assist/shipment；
# - 目标是把 Shipment prepare 阶段使用的候选仓履约扫描逻辑收回 TMS 主域；
# - 本模块只做扫描/聚合，不选仓、不写库、不承担 WMS 硬出库职责。
