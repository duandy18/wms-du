# app/shipping_assist/records/routes_cost_analysis.py
...
from app.shipping_assist.records.contracts import (
...
from app.shipping_assist.records.repository_cost_analysis import get_records_cost_analysis
