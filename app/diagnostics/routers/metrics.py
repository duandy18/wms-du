# app/diagnostics/routers/metrics.py
...
from app.analytics.contracts.metrics_alerts import AlertsResponse
...
from app.diagnostics.services.outbound_metrics_v2 import OutboundMetricsV2Service
