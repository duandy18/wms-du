# app/diagnostics/routers/flow_replay.py
...
from app.diagnostics.services.inventory_flow_service import InventoryFlowService
from app.diagnostics.services.ledger_replay_service_impl import LedgerReplayService
