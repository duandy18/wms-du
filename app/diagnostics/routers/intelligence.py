# app/diagnostics/routers/intelligence.py
...
from app.diagnostics.services.inventory_insights_service import InventoryInsightsService
from app.diagnostics.services.inventory_predict_service import InventoryPredictService
