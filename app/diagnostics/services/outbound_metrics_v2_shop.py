# app/diagnostics/services/outbound_metrics_v2_shop.py
...
from app.analytics.contracts.metrics_outbound_v2 import OutboundShopMetric, OutboundShopMetricsResponse
