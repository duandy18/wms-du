# app/diagnostics/services/trace_service.py
...
from app.diagnostics.services.trace_normalize import normalize_ts
from app.diagnostics.services.trace_sources import (
    from_audit_events,
    from_event_store,
    from_ledger,
    from_orders,
...
from app.diagnostics.services.trace_types import TraceEvent, TraceResult
