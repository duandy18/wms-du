# app/diagnostics/services/outbound_metrics_v2_failures.py
...
from app.analytics.contracts.metrics_outbound_v2 import OutboundFailureDetail, OutboundFailuresMetricsResponse
