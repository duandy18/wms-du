...
def get_permission_service(db: Session = Depends(get_db)): return PermissionService(db)
...
def get_all_permissions(perm_service: PermissionService = Depends(get_permission_service),
                        user_service: UserService = Depends(get_user_service),
                        current_user: dict = Depends(get_current_user)):
    try:
