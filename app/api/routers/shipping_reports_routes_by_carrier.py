# app/api/routers/shipping_reports_routes_by_carrier.py
...
from app.api.routers.shipping_reports_schemas import ShippingByCarrierResponse, ShippingByCarrierRow
