# app/api/routers/print_jobs/endpoints.py
...
from app.services.print_jobs_service import (
    load_print_job,
    mark_print_job_failed,
    mark_print_job_printed,
)

# TODO(you): 替换为你项目里真实的 AsyncSession 依赖函数
# 常见名字：get_session / get_db / get_async_session / get_uow_session
