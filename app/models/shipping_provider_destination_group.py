...
class ShippingProviderDestinationGroup(Base):
    ...
    __table_args__ = (
        UniqueConstraint("scheme_id", "sort_order", name="uq_sp_dest_groups_scheme_sort_order"),
    )
    ...
    scheme = relationship("ShippingProviderPricingScheme", back_populates="destination_groups", lazy="selectin")
    ...
    def __repr__(self) -> str:
        return (
            ...
            f"scheme_id={self.scheme_id} name={self.name!r}>"
        )
