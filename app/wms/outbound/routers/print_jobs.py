# app/wms/outbound/routers/print_jobs.py
...
from app.wms.outbound.services.print_jobs_service import load_print_job, mark_print_job_failed, mark_print_job_printed
