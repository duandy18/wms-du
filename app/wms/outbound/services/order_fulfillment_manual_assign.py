# app/wms/outbound/services/order_fulfillment_manual_assign.py
...
from app.wms.outbound.services.warehouse_router import OrderContext, OrderLine, StockAvailabilityProvider, WarehouseRouter
