# app/wms/outbound/services/pick_task_commit_ship_apply.py
...
from app.wms.outbound.services.pick_task_commit_ship_apply_stock import apply_stock_deductions_impl
