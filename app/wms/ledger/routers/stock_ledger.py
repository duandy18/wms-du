...
from app.wms.analysis.routers import (
    stock_ledger_routes_reconcile,
    stock_ledger_routes_shadow_lot,
)
from app.wms.ledger.routers import (
...
def _register_all_routes() -> None:
    ...
    - /reconcile            对账
    - /export               导出
    - /shadow-reconcile-lot lot 维度影子对账（Phase 4A-2a）
    """
    ...
    stock_ledger_routes_shadow_lot.register(router)
