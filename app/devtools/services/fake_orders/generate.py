# app/devtools/services/fake_orders/generate.py
from __future__ import annotations

import random
from typing import Any, Dict, List, Tuple

from app.devtools.services.fake_orders.types import FakeLink, FakeOrderAddr, FakeSeed, FakeShopSeed, FakeVariant
