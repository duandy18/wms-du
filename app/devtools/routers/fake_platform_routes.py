# app/devtools/routers/fake_platform_routes.py
...
from app.devtools.helpers.fake_platform import build_order_ref, normalize_platform
from app.devtools.contracts.fake_platform import (
    FakeOrderStatusIn,
    FakeOrderStatusOut,
