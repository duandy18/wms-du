# app/analytics/routers/finance_overview_routes_shop.py
...
from app.analytics.helpers.finance_overview import (
    clean_platform,
    clean_shop_id,
    ensure_default_7d_range,
    parse_date_param,
)
from app.analytics.contracts.finance_overview import FinanceShopRow
