# app/wms/procurement/services/purchase_order_receive_workbench_builder.py
...
from app.procurement.contracts.purchase_order_receive_workbench import (
    PoSummaryOut,
    ReceiptSummaryOut,
...
def merge_batches(
    *,
    ...
    """
    合并 confirmed + draft，按 (lot_code, production_date, expiry_date) 聚合 qty_received。
    ...
    for b in confirmed:
        key = (getattr(b, "lot_code", None), b.production_date, b.expiry_date)
